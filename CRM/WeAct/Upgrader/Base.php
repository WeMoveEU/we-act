 ...
 */
class CRM_WeAct_Upgrader_Base {

  /**
   * @var CRM_WeAct_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      self::$instance = new CRM_WeAct_Upgrader(
        'eu.wemove.we-act',
        E::path()
      );
    }
   ...
   *
   * ```
   * CRM_WeAct_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_WeAct_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
